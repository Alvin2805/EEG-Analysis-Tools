/*#############################################################################
                       ...
                       FFT_COH(char *new_z,int time,int EEG_CH)
...
FFT_COH(char *new_z,int time,int EEG_CH)
{
  int MAT, i, j, total_data, total_electrodes, start, end;
  ...
  sprintf(fin,"%s-%d.allcsd",new_z,time);
...
/*################FFT Calculation for EMG_CH################*/
	...
	p = pp;
      ...
      sprintf(fout_p,"%s_ch%d_%d-%d.fftp",new_z,EMG_CH,start,end);
      FOUT_P = fopen(fout_p, "w");
      sprintf(fout_ri,"%s_ch%d_%d-%d.fftri",new_z,EMG_CH,start,end);
...
/*################FFT Calculation for EEG_CH################*/
	...
	p = pp;
      ...
      sprintf(fout_p,"%s_ch%d_%d-%d.fftp",new_z,EEG_CH,start,end);
      FOUT_P = fopen(fout_p, "w");
      sprintf(fout_ri,"%s_ch%d_%d-%d.fftri",new_z,EEG_CH,start,end);
      FOUT_RI = fopen(fout_ri, "w");
    ...
    for(i=0;i<(total_data / INTERVAL);i++){
      ...
      sprintf(fin_1,"%s_ch%d_%d-%d.fftri",new_z,EMG_CH,start,end);
      sprintf(fin_2,"%s_ch%d_%d-%d.fftri",new_z,EEG_CH,start,end);
	...
	exit(-1);
      ...
      sprintf(fout,"%s_%d-%d.x_sp",new_z,start,end);
      FOUT=fopen(fout,"w");
      i_x = 0;
    ...
    for(i=0;i<(total_data /INTERVAL);i++){
      ...
      sprintf(fin,"%s_ch%d_%d-%d.fftp",new_z,EMG_CH,start,end);
    ...
    sprintf(fout,"%s-%d_ch%d.linuxcsd.px",new_z,time,EMG_CH);
    ...
    for(i=0;i<(total_data / INTERVAL);i++){
      ...
      sprintf(fin,"%s_ch%d_%d-%d.fftp",new_z,EEG_CH,start,end);
    ...
    sprintf(fout,"%s-%d_ch%d.linuxcsd.py",new_z,time,EEG_CH);
    ...
    for(i=0;i<(total_data /INTERVAL);i++){
      ...
      sprintf(fin,"%s_%d-%d.x_sp",new_z,start,end);
    ...
    sprintf(fout,"%s-%d_ch%dch%d.linuxcsd.xsp",new_z,time,EMG_CH,EEG_CH);
    ...
    /*################Coherence & Phase################*/
     ...
     sprintf(fin_px,"%s-%d_ch%d.linuxcsd.px",new_z,time,EMG_CH);
     sprintf(fin_py,"%s-%d_ch%d.linuxcsd.py",new_z,time,EEG_CH);
     sprintf(fin_xsp,"%s-%d_ch%dch%d.linuxcsd.xsp",new_z,time,EMG_CH,EEG_CH);
     ...
     sprintf(fout,"%s-%d_ch%dch%d.linuxcsd",new_z,time,EMG_CH,EEG_CH);
     FOUT = fopen(fout,"w");
