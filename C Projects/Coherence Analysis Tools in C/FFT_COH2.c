...
main(int argc, char *argv[ ])
{
  ...
  /*################Memory Allocation and Initialization################*/
    ...
    if(data == NULL){
        puts("data --> Cannot allocate the memory");
        exit(1);
    }
